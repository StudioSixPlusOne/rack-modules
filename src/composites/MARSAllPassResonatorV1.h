...
class MARSAllPassResonatorV1Description : public IComposite
{
public:
...
template <class TBase>
class MARSAllPassResonatorV1Comp : public TBase
{
public:
    MARSAllPassResonatorV1Comp (Module* module) : TBase (module)
    {
    }

    MARSAllPassResonatorV1Comp() : TBase()
    {
    }

    virtual ~MARSAllPassResonatorV1Comp()
    {
    }
    ...
    */
    ...
    {
        return std::make_shared<MARSAllPassResonatorV1Description<TBase>>();
    }
...
template <class TBase>
inline void MARSAllPassResonatorV1Comp<TBase>::step()
{
    auto channels = std::max (TBase::inputs[MAIN_INPUT].getChannels(),
                              TBase::inputs[MAIN_INPUT].getChannels());
...
template <class TBase>
int MARSAllPassResonatorV1Description<TBase>::getNumParams()
{
    return MARSAllPassResonatorV1Comp<TBase>::NUM_PARAMS;
}

template <class TBase>
IComposite::Config MARSAllPassResonatorV1Description<TBase>::getParam (int i)
{
    ...
    switch (i)
    {
        case MARSAllPassResonatorV1Comp<TBase>::RESONANCE_PARAM:
            ret = { 0.0f, 1.0f, 0.5f, "RESONANCE", " ", 0.0f, 1.0f, 0.0f };
            break;

        case MARSAllPassResonatorV1Comp<TBase>::FREQUENCY_PARAM:
            ret = { 0.0f, 1.0f, 0.5f, "FREQUENCY", " ", 0.0f, 1.0f, 0.0f };
            break;
