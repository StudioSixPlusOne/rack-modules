...
#include "../plugin.hpp"
#include "MARSAllPassResonatorV1.h"
#include "WidgetComposite.h"
#include "../ctrl/SqMenuItem.h"
#include "../widgets.h"
#include "AudioMath.h"

using Comp = MARSAllPassResonatorV1Comp<WidgetComposite>;

struct MARSAllPassResonatorV1 : Module
{
...
struct MARSAllPassResonatorV1Widget : ModuleWidget
{
    MARSAllPassResonatorV1Widget (MARSAllPassResonatorV1* module)
    {
        setModule (module);
        std::shared_ptr<IComposite> icomp = Comp::getDescription();
        ...
        addParam (createParamCentered<sspo::Knob> (mm2px (Vec (41.01, 47.493)), module, Comp::RESONANCE_PARAM));
        addParam (createParamCentered<sspo::Knob> (mm2px (Vec (41.01, 70.247)), module, Comp::FREQUENCY_PARAM));
...
Model* modelMARSAllPassResonatorV1 = createModel<MARSAllPassResonatorV1, MARSAllPassResonatorV1Widget> ("MARSAllPassResonatorV1");