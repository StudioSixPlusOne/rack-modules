...
using MA = MARS_Basic_Comb_FilterComp<TestComposite>;
...
static void testExtreme (float sr)
{
    ...
    ExtremeTester<MA>::test (ma, paramLimits, true, "MARS_Basic_Comb_Filter");
}
...
void testMARS_Basic_Comb_Filter()
{
    printf ("test MARS_Basic_Comb_Filter\n");
    testExtreme();
}