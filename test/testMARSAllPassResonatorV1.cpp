...
using MA = MARSAllPassResonatorV1Comp<TestComposite>;
...
static void testExtreme (float sr)
{
    ...
    ExtremeTester<MA>::test (ma, paramLimits, true, "MARSAllPassResonatorV1");
}
...
void testMARSAllPassResonatorV1()
{
    printf ("test MARSAllPassResonatorV1\n");
    testExtreme();
}